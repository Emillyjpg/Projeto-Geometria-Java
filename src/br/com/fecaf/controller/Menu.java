            ...
            switch (optionUser) {
                ...
                case 3:
                    ...
                    while (!exitTriangulo) {
                        ...
                        System.out.println("/* 2 - Calcular Area");
                        System.out.println("/* 3 - Calcular Perimetro");
                        System.out.println("/* 4 - Descobrir se é retangulo");
                        System.out.println("/* 5 - Esse triangulo é um 3 4 5?");
                        ...
                        switch (optionTriangulo) {
                            ...
                            // Por fim, Eu começo a modificar a parte de escolhas do codigo,
                            //dando a oportunidade do usurio escolher seus proximos passos.
                            case 4:
                                if(validaTriangulo){
                                    triangulo.descobrirTrianRatan();
                                }else {
                                    System.out.println("Cadastre um Triangulo");
                                }
                                break;
                            case 5:
                                if(validaTriangulo){
                                    triangulo.verificandoTriangulo();
                                }else {
                                    System.out.println("Cadastre um Triangulo");
                                }
                                break;
